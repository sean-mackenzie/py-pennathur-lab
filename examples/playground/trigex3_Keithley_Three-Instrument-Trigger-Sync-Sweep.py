...
# The following configures the Trigger Model for SMU1:
...
# The following initializes SMU1
...
k1.write('sour:cle:auto on')        # Automatically turn output ON/OFF
k1.write('sour:cle:auto:mode: tco') # Output off after trigger count

# the below is from the 2 instrument example (not sweeping)

# the below is from the 3 instrument example
